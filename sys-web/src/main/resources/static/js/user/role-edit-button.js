layui.use(['element', 'form', 'laypage'], function () {
    ...
    form.on('submit(edit)', function (data) {
        ...
        ajaxCommit(AdminConstant.API.ROLE_SAVE_BUTTON.URL, CommonConstant.AJAX_TYPE.POST, JSON.stringify(data.field), CommonConstant.CONTENT_TYPE.JSON, Role.saveSuccess, alert_error);
        return false;
    });
