...
layui.use(['element', 'form', 'laypage'], function () {
    ...
    User.searchPage = function () {
        ajaxCommit(UserConstant.API.LIST_PAGE.URL, CommonConstant.AJAX_TYPE.POST, JSON.stringify(User.queryData()), CommonConstant.CONTENT_TYPE.JSON, pageSuccess, alert_error);
    };
    ...
    function pageSuccess(data) {
        ...
        data.records.forEach(function (user) {
            ...
            $tr.append($("<td>" + LocalDateUtil.formatDateTime(user.createTime, true) + "</td>"));
            ...
            $aEdit.attr("onclick", "xadmin.open('修改管理员', '" + UserConstant.API.EDIT.URL + "?userId=" + user.id + "', 700, 500)");
