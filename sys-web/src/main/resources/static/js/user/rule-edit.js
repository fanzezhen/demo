layui.use(['element', 'form', 'laypage'], function () {
    ...
    form.on('submit(edit)', function (data) {
        ...
        ajaxCommit(AdminConstant.API.RULE_SAVE.URL, CommonConstant.AJAX_TYPE.POST, JSON.stringify(data.field), CommonConstant.CONTENT_TYPE.JSON, Rule.saveSuccess, alert_error);
        return false;
    });
